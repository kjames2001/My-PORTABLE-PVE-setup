...
The shutdown permission add to user kodi above, was so that if you need to access proxmox console via the display for any reason, then you could shutdown the lxc as it will not automatically start again while your display is plugged in.
